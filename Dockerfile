...
ADD https://gmplib.org/download/gmp/gmp-6.3.0.tar.xz /home/lac/libs/gmp.tar.xz
ADD https://www.mpfr.org/mpfr-current/mpfr-4.2.2.tar.xz /home/lac/libs/mpfr.tar.xz
