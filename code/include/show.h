...
// Four-squares slot for v11 in s1
#define IDX_V11_FS (IDX_V1_SHOW + PARAM_D * PARAM_K_SHOW)
// Starting index for v12 in s1
#define IDX_V12_SHOW (IDX_V11_FS + 1)
// Four-squares slot for v12 in s1
#define IDX_V12_FS (IDX_V12_SHOW + PARAM_D * PARAM_K_SHOW)
// Starting index for v2 in s1
#define IDX_V2_SHOW (IDX_V12_FS + 1)
// Four-squares slot for v2 in s1
#define IDX_V2_FS (IDX_V2_SHOW + PARAM_D * PARAM_KH * PARAM_K_SHOW)
// Starting index for v3 in s1
#define IDX_V3_SHOW (IDX_V2_FS + 1)
// Four-squares slot for v3 in s1
#define IDX_V3_FS (IDX_V3_SHOW + PARAM_K_SHOW)
// Starting index for tag in s1
#define IDX_TAG_SHOW (IDX_V3_FS + 1)
...
// Starting index for bimodal bit b in s1
#define IDX_B_SHOW (IDX_M_SHOW + PARAM_M * PARAM_K_SHOW)
...
void show_user_embed(
    ...
    poly_qshow_mat_k_k B_embed[PARAM_D][PARAM_D * PARAM_KH],
    poly_qshow_mat_k_k A3_embed[PARAM_D][1],
...
void show_user_prove(
    ...
    const poly_qshow_mat_k_k B_embed[PARAM_D][PARAM_D * PARAM_KH],
    const poly_qshow_mat_k_k A3_embed[PARAM_D][1],
